...
const navItems = [
  ...
  { id: "featured", name: "Featured", href: "#featured", icon: <Star size={18} className="sm:w-5 sm:h-5" /> },
  ...
  { id: "certifications", name: "Certifications", href: "#certifications", icon: <Award size={18} className="sm:w-5 sm:h-5" /> },
