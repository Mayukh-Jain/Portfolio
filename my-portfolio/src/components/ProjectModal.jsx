        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            ...
            <div className="flex gap-3 mt-6 md:mt-0 w-full md:w-auto">
               <a href={project.liveLink} target="_blank" className="flex-1 md:flex-none justify-center flex items-center gap-2 px-4 py-3 bg-white text-black rounded-md font-medium hover:bg-gray-200 transition-colors text-sm">
                 <ExternalLink size={16} /> Live Demo
               </a>
               <a href={project.repoLink} target="_blank" className="flex-1 md:flex-none justify-center flex items-center gap-2 px-4 py-3 border border-white/20 text-white rounded-md hover:bg-white/10 transition-colors text-sm">
                 <Github size={16} /> Code
               </a>
            </div>
          </div>
